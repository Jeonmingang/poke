...
public class PhotoItemUtil {
    ...
    public static ItemStack buildPhotoItem(Player p, PixelmonSpecUtil.Result r) {
        ...
        lore.add(ChatColor.AQUA + "기술 §f: " + joinMovesWithPP(r));
        lore.add(ChatColor.DARK_GREEN + "능력치 §f: " + r.statsLine);
    ...
    private static java.awt.image.BufferedImage tryLoadSprite(String species, String form) {
        try {
